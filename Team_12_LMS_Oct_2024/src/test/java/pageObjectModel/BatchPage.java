...
public void LoginTM(String username,String pwd) {
	UserName.sendKeys(username);
	password.sendKeys(pwd);
	login.click();
}

public void click_BatchTab_TM()
{
	batch_tab.click();
}
public boolean check_landingPage_TM()
{
	String currentURL;
	currentURL=driverFactory.getDriver().getCurrentUrl();
	System.out.println(currentURL);
...
public boolean check_batchPage_TM()
{
	String currentURL;
	currentURL=driverFactory.getDriver().getCurrentUrl();
	System.out.println(currentURL);
...
public boolean check_deleteIcon_TM()
{
...
public boolean check_checkboxIcon_TM()
{
...
public void check_tableheaders_TM()
{
...
public boolean check_checkboxInHeader_TM()
{
	boolean actual=tableHeaderCheckBox.isDisplayed();
	return actual;
	}
public boolean check_sortIconsInTableHeader_TM()
{
	//
...
public boolean check_addNewBatch_TM()
{
	boolean actual=addNewBatch_tab.isDisplayed();
	return actual;
}
public void click_addNewBatch_TM()
{
	addNewBatch_tab.click();
}
public boolean check_batchPopupWindow_TM()
{
